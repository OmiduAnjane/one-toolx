    ...
    <ul class="navbar-nav justify-content-end">
        ...
        <li class="nav-item dropdown d-flex align-items-center">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" aria-labelledby="dropdownMenuButton">
                <?php $__currentLoopData = localization()->getSupportedLocales(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localeCode => $properties): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="mb-2">
                      <a class="dropdown-item mb-1" rel="alternate" hreflang="<?php echo e($localeCode); ?>" href="<?php echo e(localization()->getLocalizedURL($localeCode, null, [], true)); ?>">
        ...
        <div class="nav-item dropdown d-none d-md-flex me-3">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-card dropdown-menu-arrow">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(__('Script version')); ?>: <span class="badge bg-success"><?php echo e(env('APP_VERSION')); ?></span>
                        </table>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\laravel\sumowebtools\components\resources\views/components/admin/navright.blade.php ENDPATH**/ ?>